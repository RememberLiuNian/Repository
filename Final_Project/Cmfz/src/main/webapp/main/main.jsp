...
<head>
    ...
    <script type="text/javascript">
                ...
                success: function (data) {
                    ...
                    $.each(data, function (index, first) {
                        ...
                        $.each(first.menus, function (index, second) {
                            c = c + '<p style="text-align: center"><a href="#" class="easyui-linkbutton" data-options="iconCls:\'' + second.iconCls + '\'" onclick=\'addBannerTabs("'+second.title+'","'+second.iconCls+'","'+second.href+'")\'>' + second.title + '</a></p>';
                        });
                        //一级模块
                        $('#aa').accordion('add', {
                            title: first.title,
        ...
        //添加图片轮播选项卡
        function addBannerTabs(title,iconCls,href){
