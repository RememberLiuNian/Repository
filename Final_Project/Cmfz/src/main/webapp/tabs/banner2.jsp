...
<head>
    ...
    <script type="text/javascript">
        $(function(){
            ...
            $('#myTable').edatagrid({
                //请求地址
                url:"${pageContext.request.contextPath}/banner/getBanners",
                //显示分页
                pagination:true,
                method: "get",
                //工具栏
                ...
                detailFormatter: function (rowIndex, rowData) {
                    return '<table><tr>' +
                        '<td rowspan=2 style="border:0"><img src="' + "${pageContext.request.contextPath}/tabs" + rowData.url + '" style="height:50px;"></td>' +
                        '<td style="border:0">' +
...
<div id="dialogButtons">
    <a class="easyui-linkbutton" onclick="doAdd()">添加</a>
    <a class="easyui-linkbutton" onclick="closeDia()">取消</a>
</div>
</body>
</html>
